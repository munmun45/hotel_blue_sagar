            ...
            <tr>
              <td style="width: 50%; vertical-align: top; padding: 10px; border-right: 1px solid #ddd;">
                <div style="font-size: 14px; line-height: 1.6;">
                  <p style="font-weight: bold; font-size: 16px; margin-bottom: 10px; color: #2a2a2a;">Hotel Blue Sagar:</p>
                  <p style="margin: 0; color: #555;">Number: <span style="color: #000;">8339919839</span></p>
                  <p style="margin: 0; color: #555;">GST: <span style="color: #000;">N/A</span></p>
                  <p style="margin: 0; color: #555;">Address: <span style="color: #000;">Bidhaba Ashram Chaka, Bengali Market, Swargadwar, Puri, Odisha</span></p>
